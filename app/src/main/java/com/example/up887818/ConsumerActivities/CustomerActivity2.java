...
public class CustomerActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extra = new ExtraMethods(this, CustomerActivity2.this);
        ...
        String[] activityStrings = getResources().getStringArray(R.array.customeractivity2);

        yesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (finished){
                    navigateUpTo(new Intent(CustomerActivity2.this, Temp.class));
                }
            }
        });
