...
public class CustomerActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extra = new ExtraMethods(this, CustomerActivity4.this);
        ...
        String[] activityStrings = getResources().getStringArray(R.array.customeractivity4);

        yesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (finished){
                    navigateUpTo(new Intent(CustomerActivity4.this, Temp.class));
                }
            }
        });
