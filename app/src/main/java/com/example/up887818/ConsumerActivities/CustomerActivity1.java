...
public class CustomerActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extra = new ExtraMethods(this, CustomerActivity1.this);
        ...
        String[] activityStrings = getResources().getStringArray(R.array.customeractivity1);

        yesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (finished){
                    navigateUpTo(new Intent(CustomerActivity1.this, Temp.class));
                }
            }
        });
