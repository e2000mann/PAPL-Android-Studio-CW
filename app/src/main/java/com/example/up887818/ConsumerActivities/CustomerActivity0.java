...
import com.example.up887818.HygieneActivities.HygieneActivity0;
...
public class CustomerActivity0 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extra = new ExtraMethods(this, CustomerActivity0.this);
        ...
        String[] activityStrings = getResources().getStringArray(R.array.customeractivity0);

        yesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (finished){
                    navigateUpTo(new Intent(CustomerActivity0.this, Temp.class));
                }
            }
        });
