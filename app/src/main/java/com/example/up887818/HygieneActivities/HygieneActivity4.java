...
public class HygieneActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extra = new ExtraMethods(this, HygieneActivity4.this);
        ...
        String[] activityStrings = getResources().getStringArray(R.array.hygieneactivity4);
