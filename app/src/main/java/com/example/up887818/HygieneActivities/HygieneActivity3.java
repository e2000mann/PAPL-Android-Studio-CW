...
public class HygieneActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extra = new ExtraMethods(this, HygieneActivity3.this);
        ...
        String[] activityStrings = getResources().getStringArray(R.array.hygieneactivity3);
